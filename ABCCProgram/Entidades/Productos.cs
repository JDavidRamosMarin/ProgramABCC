...
namespace ABCCProgram.Entidades
{
    public class Productos
    {
        ...
        [Range(1, 99, ErrorMessage = "Ingresa un valor valido para departamento.")]
        public int ClaseId { get; set; }
        public Clase ClaseTab { get; set; }

        [Range(1, 999, ErrorMessage = "Ingresa un valor valido para departamento.")]
        public int FamiliaId { get; set; }
        public Familia FamiliaTab { get; set; }
        public DateTime FechaDeAlta { get; set; }

        [Range(1, 999999999, ErrorMessage = "Ingresa un valor valido para departamento.")]
        public int Stock { get; set; }

        [Range(1, 999999999, ErrorMessage = "Ingresa un valor valido para departamento.")]
        public int Cantidad { get; set; }

        [Range(0, 1, ErrorMessage = "Ingresa un valor valido para departamento.")]
